...
class HuamiAmazfit:
    ...
    def get_wearable_auth_keys(self) -> dict:
        ...
        for wearable in devices:
            ...
            devices_dict[f'status'] = "success"
            devices_dict[f'address'] = mac_address
            devices_dict[f'authToken'] = (key_str if key_str != '' else '00')
            devices_dict[f'lastActive'] = wearable['lastActiveStatusUpdateTime']
            devices_dict[f'firmwareVersion'] = wearable['firmwareVersion']
            devices_dict[f'activeStatus'] = wearable['activeStatus']
